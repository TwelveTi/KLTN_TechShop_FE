import { type Product, isOnSale } from '@domain/product'
...
export function ProductCard({
  ...
  const isDeal = variant === 'deal' || isOnSale(product)
      ...
      <div className="ts-product-card__body">
        ...
        <div className="ts-product-card__footer">
          <div className="ts-product-card__pricing">
            <span className="ts-product-card__price tabular-nums">{formatVnd(product.priceVnd)}</span>
            {product.originalPriceVnd !== undefined && (
              <span className="ts-product-card__original-price tabular-nums">{formatVnd(product.originalPriceVnd)}</span>
            )}
          </div>
